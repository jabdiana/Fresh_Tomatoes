...
#List of movies including (Title, Image, Trailer)
...
movies = [Fight_Club,Fast_And_Furious_7,Deadpool,SWAT,Dark_Knight,Zootopia,Iron_Man_3,Big_Hero_6,Dr_Strange,Moana,
          Creed, Friends_With_Benefits, Shooter,Lone_Survivor,Central_Intelligence,Avengers,Now_You_See_Me,Civil_War]
